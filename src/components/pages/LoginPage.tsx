...
import { loginLocalAuthUser, setSessionUser } from '@/lib/session';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="bg-card-background rounded-2xl p-8 shadow-[0_10px_20px_rgba(0,0,0,0.2)]">
          ...
          <p className="text-foreground/70 font-paragraph mb-6">Sign in to continue</p>
          ...
          <p className="text-center text-foreground/70 font-paragraph text-sm mt-6">
            ...
            <Link to="/register" className="text-primary hover:text-secondary transition-colors duration-300 font-semibold">
              Sign up
            </Link>
          </p>
        </div>
